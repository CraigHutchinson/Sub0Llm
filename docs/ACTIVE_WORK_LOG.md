...
| 2026-09-22 | Codex + delegated audit agent | Intel I21 selected-arm prepared-copy resume | `main` | `benchmarks/intel/mechanisms/prepared_copy.cpp`, `scripts/intel/bench/`, Intel I21 docs/evidence; no engine or O5 files | active | Resuming the 2026-09-09 explicit gate. Add one selected arm per process while preserving the all-mode inventory invocation; validate contracts and compilation first. No hardware timing while O5 delegates are active. |
