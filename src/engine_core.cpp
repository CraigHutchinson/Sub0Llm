...
// The runtime tokenizer state (loaded from tokenizer.bin). Loading, encoding and detokenizing all
...
void warn_tok_model_mismatch() {
    std::println(stderr,
        ...
        "       Decoding would produce garble. This usually means the build's tokenizer.bin was "
        "regenerated by a later `configure` for a different corpus.\n"
        "       Fix: use the tokenizer.bin bundled in the model's directory, or re-run `configure` "
...
// ============================================================================
//  Runtime BPE tokenizer (loaded from tokenizer.bin) -- state declared up top
